...
CREATE TABLE IF NOT EXISTS contracts (id BIGINT PRIMARY KEY AUTO_INCREMENT, user_id BIGINT, template_id BIGINT, title VARCHAR(120), content MEDIUMTEXT, status VARCHAR(32), signed_at DATETIME, expire_date DATETIME, amount DECIMAL(12,2), signers JSON);
